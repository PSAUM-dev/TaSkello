                ...
                <div class="card border-1 mt-2">
                    <div class="car-body p-4">
                        ...
                        <form action="{{ route('registerAccount') }}" method="post">
                            ...
                            <div>
                                <input class="form-control" type="text" name="name" id="" placeholder="Nom d'utilisateur..." />

                                <input class="form-control mt-3" type="email" name="email" id="" placeholder="Adresse email..." />
                            ...
                            <div class="mt-3">
                                ...
                                <p class="mt-4 text-center">Vous avez déjà un compte ?  <a href="{{ route('login') }}">Connectez-vous ici</a></p>
                            </div>
